<div class="col-xs-3" style="padding-top:1px;text-align:right;">
	...
	<span><a href="/{{$base}}/{{date('Y-m-d', strtotime($fromdate) - 86400)}}/{{date('Y-m-d', strtotime($fromdate) - 86400)}}" class="btn btn-default"><</a></span>&nbsp;<span><a href="/{{$base}}/{{date('Y-m-d', time())}}/{{date('Y-m-d', time())}}" class="btn btn-default">today</a></span><span><a href="/{{$base}}" class="btn btn-default">all</a></span>&nbsp;<span><a href="/{{$base}}/{{date('Y-m-d', strtotime($fromdate) + 86400)}}/{{date('Y-m-d', strtotime($fromdate) + 86400)}}" class="btn btn-default">></a></span>
	@else
